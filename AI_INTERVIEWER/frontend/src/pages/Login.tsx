  ...
  useEffect(() => {
    ...
    if (token && userId) {
      useAuthStore.setState({
        ...
        user: { id: userId, name: name || 'User', email: emailParam || '' },
        token,
      })
      navigate('/')
    }
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-on-surface-muted mt-4 text-base leading-relaxed max-w-md">
                ...
                solve coding challenges, and track your progress — all powered by Groq AI.
              </p>
            </div>
        ...
        <div className="w-full max-w-sm animate-fade-in-up relative z-10">
          ...
          <div className="glass rounded-2xl p-7 space-y-5">
            <div className="text-center">
              ...
              <p className="text-sm text-on-surface-muted mt-1">Sign in to continue your interview prep</p>
            </div>
            ...
            <p className="text-center text-sm text-on-surface-muted">
              ...
              <Link to="/register" className="text-accent-amber hover:text-accent-amber/80 font-semibold transition-colors">Create one</Link>
            </p>
          </div>
        </div>
      </div>
